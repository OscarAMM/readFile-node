...
fs.readFile('./././catmid/antiguo/parte_2_1_al_18_enero_2024.txt', 'utf8', (error, data) => {
  if (error) {
  ...
  fs.writeFile('./././catmid/nuevo/parte_2_1_al_18_enero_2024.txt', (outputData.includes("delete")) ? modifiedData : outputData, 'utf8', error => {
    if (error) {
